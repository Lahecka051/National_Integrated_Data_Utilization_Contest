import type { Errand, RecommendationResponse, SlotRecommendation, TaskList, HalfDayType, NLParseResponse, ChatMessage, TimeConstraint, ConsultantChatResponse } from '../types'
